...
function nombreWeb($sitio) {
	...
	switch($url) {
		...
		case '37': // historial/administrar/editar
			$GLOBALS['website_ruta'] = "<a href='./'>".$GLOBALS['website_nombre']."</a> ".separador()." <a href='?sitio=".toUrl(36)."'>Administrar preguntas del historial medico</a> ".separador()." Editar pregunta";
